...
const ContactUs = () => {
    ...
    const onSubmit = (data: FormData) => {
        ...
        // Manually trigger native form submission to Zoho Forms
        if (formRef.current) {
                        ...
                        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                            ...
                            >
                                <div className="w-full px-4 lg:w-10/12 xl:w-9/12 text-center">
                                    <motion.h2 className="text-4xl lg:text-5xl font-bold leading-tight mb-4" variants={itemVariants}>{t('heroHeading')}</motion.h2>
                                    <motion.p className="text-lg text-gray-700 leading-relaxed" variants={itemVariants}>{t('heroSubHeading')}</motion.p>
                                </div>
                            </motion.div>
                        </div>
                    </motion.div>
